                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card box-shadow mb-2">
                                    <div class="card-body">
                                        <div class="container">
                                        <form method="POST" action="/teacher/manage/section/{{ $section->id }}/update" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <div class="row input_section_wrap">
                                                    <div class="col-md-4">
                                                        <input class="form-control f-input" name="section" type="text" value="{{ $section->section }}" style="width: 100px; height: 35px; margin-bottom: 10px">
                                                    </div>
                                                </div>
                                            </div>
