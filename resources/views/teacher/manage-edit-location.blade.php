                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">แก้ไขสถานที่</h2>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card box-shadow mb-2">
                                    <div class="card-body">
                                        <div class="container">
                                        <form method="POST" action="/teacher/manage/location/{{ $location->id }}/update" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="input_location_wrap">
                                                    <div class="card p-4">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input class="form-control f-input"  name="location_name" type="text" value="{{ $location->name }}" style="width: 100%; height: 35px; margin-bottom: 10px">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input class="form-control f-input"  name="location_latitude" type="text" value="{{ $location->latitude }}" style="width: 100%; height: 35px; margin-bottom: 10px">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="location_longtitude" class="pt-1">ลองจิจูด</label>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input class="form-control f-input"  name="location_longitude" type="text" value="{{ $location->longitude }}" style="width: 100%; height: 35px; margin-bottom: 10px">
                                                            </div>
                                                        </div>
                                                    </div>
