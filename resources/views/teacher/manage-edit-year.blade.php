                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card box-shadow mb-2">
                                    <div class="card-body">
                                        <div class="container">
                                        <form method="POST" action="/teacher/manage/year-term/{{ $year->id }}/update" enctype="multipart/form-data">
                                            @csrf
                                                    ...
                                                    <div class="form-group mt-2">
                                                        ...
                                                        <div class="input_year_wrap">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input class="form-control f-input" name="year" value="{{ $year->year }}" type="text">
                                                                </div>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input class="form-control f-input" name="term" value="{{ $year->term }}" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
