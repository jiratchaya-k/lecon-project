                ...
                <div class="ecommerce-widget">
                    <div class="container">
                        <div class="card box-shadow mb-2">
                            <div class="card-body">
                                <form method="POST" action="/teacher/subject/{{ $subject->id }}/add-section/store" enctype="multipart/form-data">
                                    @csrf

                                    <div class="container row">
                                        <div class="form-group col-md-4">
                                            <label for="title" class="control-label">รหัสวิชา {{ $subject->code }}</label>
                                            {{--<input class="form-control f-input" name="subject_code" type="text">--}}
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label for="title" class="control-label">ชื่อวิชา {{ $subject->name }}</label>
                                            <input class="form-control f-input" name="subject_id" type="hidden">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5 item-center mt-5 mb-3">
                                        <input class="btn btn-dark btn-submit" type="submit" value="เพิ่มกลุ่มเรียน" style="background: #3956A3 !important; border: none; width: 100%">
                                    </div>
